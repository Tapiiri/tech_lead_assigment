...
def seed_feedback(db: Session):
    ...
    samples = [
        FeedbackCreate(feedback="Great team culture, clear communication, and strong support for growth."),
        FeedbackCreate(feedback="The process was smooth and the team was very supportive.")
    ]
